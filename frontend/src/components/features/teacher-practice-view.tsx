    ...
    <div className="p-4 md:p-6 lg:p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex gap-3">
          ...
          <Button
            ...
            className="rounded-xl bg-primary shadow-soft hover:shadow-pop transition-all"
          >
      ...
      <Tabs defaultValue="dashboard" className="w-full" onValueChange={setActiveTab}>
        <TabsList className="grid w-full max-w-[400px] grid-cols-2 rounded-xl bg-muted/50 p-1 mb-8">
          <TabsTrigger
            value="dashboard"
            className="rounded-lg font-bold data-[state=active]:bg-white data-[state=active]:shadow-soft"
          >
            Dashboard
          </TabsTrigger>
          <TabsTrigger
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="rounded-2xl border border-border/60 bg-white p-6 shadow-soft">
                <div className="mb-6 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-4 text-xs font-bold">
                    <div className="flex items-center gap-1.5">
                      <div className="h-2 w-2 rounded-full bg-primary" /> Điểm trung bình
                    </div>
                    <div className="flex items-center gap-1.5">
                      <div className="h-[2px] w-4 border-t-2 border-dashed border-gray-400" /> Mục
                      tiêu lớp
                    </div>
                  </div>
                </div>
                <div className="h-[260px] w-full">
                  <ChartContainer
                    config={{ performance: { label: "Hiệu suất", color: "hsl(var(--primary))" } }}
              ...
              <div className="rounded-2xl border border-border/60 bg-white p-6 shadow-soft">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  {[
                    ...
                    <div
                      key={idx}
                      className="p-4 rounded-xl border border-border/50 bg-muted/5 hover:bg-white hover:shadow-md transition-all group cursor-pointer"
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 text-[11px] font-semibold text-muted-foreground">
                        <span className="flex items-center gap-1">
                          <BookOpen className="h-3 w-3" /> {quiz.items} câu
                        </span>
                        <span className="flex items-center gap-1">
                          <Users className="h-3 w-3" /> {quiz.students} SV
                        </span>
              ...
              <div className="rounded-3xl bg-gradient-to-br from-[#0b4870] to-[#12669e] p-6 text-white shadow-lg overflow-hidden relative group">
                ...
                <div className="relative z-10">
                  ...
                  <p className="mb-6 text-sm text-blue-100/90 leading-relaxed font-medium">
                    Tại sao phải soạn câu hỏi thủ công? Để AI trích xuất nội dung từ tài liệu bài
                    giảng của bạn.
                  </p>
                  <Button
                    onClick={() => setIsGenerateModalOpen(true)}
                    className="w-full rounded-xl bg-white text-[#0b4870] hover:bg-white/90 font-bold h-11 shadow-soft hover:shadow-pop transform transition-all active:scale-95"
                  >
          ...
          <div className="rounded-2xl border border-border shadow-soft overflow-hidden bg-white">
            <div className="p-4 border-b border-border bg-muted/20 flex items-center justify-between">
              <h3 className="font-bold text-sm">
                ...
                <span className="text-primary tracking-tight font-black underline decoration-2 underline-offset-4">
                  Chương 4 - MLN111
                </span>
              </h3>
              <div className="flex items-center gap-2">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="h-8 pl-8 pr-4 text-xs font-medium rounded-lg border border-border focus:outline-none focus:ring-1 focus:ring-primary w-48"
                  />
                </div>
              </div>
            </div>
                  ...
                  <tr key={res.id} className="hover:bg-muted/20 transition-colors group">
                    ...
                    <td className="px-6 py-4 text-right">
                      <Button
                        variant="ghost"
                        size="sm"
                        className="h-7 w-7 rounded-lg p-0 hover:bg-primary/10 hover:text-primary transition-colors"
                      >
                        <Eye className="h-3.5 w-3.5" />
                      </Button>
                    </td>
        ...
        <DialogContent className="sm:max-w-[500px] rounded-3xl">
            ...
            <div className="p-4 rounded-2xl bg-primary/5 border border-primary/10 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-muted-foreground font-medium">
                  Hệ thống sẽ ưu tiện các nội dung quan trọng đã được giảng viên đánh dấu.
                </p>
              </div>
            </div>
          </div>
          <DialogFooter className="gap-2 sm:gap-0">
            ...
            <Button
              ...
              className="rounded-xl font-black shadow-pop"
            >
              Bắt đầu khởi tạo
            </Button>
          </DialogFooter>
        ...
        <DialogContent className="sm:max-w-[700px] rounded-3xl max-h-[90vh] overflow-hidden flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto py-6 pr-2 space-y-6">
            {[1, 2, 3].map((num) => (
              <div
                key={num}
                className="p-5 rounded-2xl border border-border bg-muted/5 space-y-4 relative overflow-hidden group"
              >
                ...
                <p className="text-sm font-bold text-foreground leading-relaxed">
                  Tại sao hàng hóa có hai thuộc tính là giá trị sử dụng và giá trị? Nhân tố nào
                  quyết định thuộc tính này?
                </p>
                  ...
                  {[
                    ...
                    <div
                      ...
                      className={cn(
                        ...
                        i === 0
                          ? "border-emerald-500/50 bg-emerald-50 text-emerald-700 ring-2 ring-emerald-500/20"
          ...
          <DialogFooter className="pt-4 border-t border-border mt-2">
            <Button
              variant="outline"
              onClick={() => setIsViewQuizOpen(false)}
              className="rounded-xl font-bold"
            >
              Quay lại
            </Button>
