  ...
  return (
    <div className="relative pt-6 w-full h-auto flex items-center justify-center">
      <button
        type="submit"
        disabled={disabled}
        className="group relative flex h-14 w-full overflow-hidden rounded-[6px] bg-[#111111] text-[#FFFFFF] text-[15px] font-medium transition-all duration-500 hover:bg-[#222222] hover:shadow-[0_8px_24px_-6px_rgba(17,17,17,0.3)] disabled:opacity-50 disabled:cursor-not-allowed border border-[#111111] items-center justify-center"
      >
            ...
            <div className="space-y-5">
              <div className="space-y-0">
                ...
                {errors.email?.message && (
                  <p className="text-[13px] text-[#9F2F2D] ml-0.5 mt-2">
                    {errors.email.message}
                  </p>
                )}
              </div>
